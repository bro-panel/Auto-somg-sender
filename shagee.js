...
const prefix = '.';
const ownerNumber = ['94703403671']; // ඔයාගේ no එක දාන්න 🙄
...
async function connectToWhatsApp() {
    ...
    conn.ev.on('connection.update', (update) => {
        ...
        if (connection === 'close') {
            ...
            console.log('👆 Running... ');
           conn.newsletterFollow("120363421350428668@newsletter") // මේ jid එක මාරු කරන්න එපා මැනිකලාහ් 😇. පහල එකට ඔයාගෙ එක දාන්න
           conn.newsletterFollow("120363421350428668@newsletter") // මේකට ඔයාගේ channel jid එක දාන්න
           console.log(" CHANNEL FOLLOW ✅")
           let up = `SONG SENDER BOT connected successful ✅\n\nPREFIX: ${prefix}`; // වෙනස් කරන්නහ්
           conn.sendMessage("94703403671@s.whatsapp.net", { image: { url: `https://i.ibb.co/sdsy6LG6/3mfp-OTP7c1.jpg` }, caption: up }) // වෙනස් කරන්නහ්
...
if (mek.key && mek.key.remoteJid === 'status@broadcast' && config.AUTO_READ_STATUS === "true"){
      ...
      if (timeDiff <= maxTime) {
        ...
        try {
          ...
          let rep = `Status seen by SONG SENDER BOT 💙`; // වෙනස් කරගන්නන 
